      ...
      <div className="container mx-auto max-w-6xl">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative aspect-square md:aspect-[4/5] w-full max-w-md mx-auto">
            ...
            <div className="absolute inset-0 bg-[#C1502E]/20 translate-x-4 translate-y-4" />
            
            <div className="relative w-full h-full border border-white/10 overflow-hidden bg-[#2C2926]">
              <Image 
                src="https://images.unsplash.com/photo-1603808033192-082d6919d3e1?ixlib=rb-4.0.3&auto=format&fit=crop&w=1000&q=80"
                alt="A collection of physical printed photos and a coffee cup"
                fill
